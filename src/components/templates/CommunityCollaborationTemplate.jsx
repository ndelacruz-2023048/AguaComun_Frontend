        ...
        <div className='flex flex-col gap-5 w-[95%]'>
            <div className='flex justify-between items-center'>
                <div className='flex flex-col gap-2'>
                    <h1 className='text-[#338826] font-bold text-3xl'>Colaboración comunitaria</h1>
                    <p className='text-[#338826] text-[16px]'>Explora y participa en actividades comunitarias</p>
                </div>
                {
            ...
            <div className='flex flex-col gap-5 '>
                <h2 className='text-[#D7AD2C] font-bold text-xl'>Actividades próximas</h2>
                {
